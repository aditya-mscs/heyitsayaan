        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 space-y-4 text-center md:text-left">
            ...
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">My Updates</h1>
              <p className="mx-auto md:mx-0 max-w-[700px] text-muted-foreground md:text-xl">
                Stay up to date with my latest activities, projects, and achievements
              </p>
            </div>
          </div>
